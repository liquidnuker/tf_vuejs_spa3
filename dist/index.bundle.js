...
var vcPageAbout = function vcPageAbout(resolve) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_replace_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_jsonloader_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_jsonFilter_js__ = __webpack_require__(18);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
  data: function data() {
    return {
      currentItem: __WEBPACK_IMPORTED_MODULE_0__js_store_js__["a" /* store */].currentItem
    };
  },
  ...
  methods: {
    refreshItems: function refreshItems() {
      this.currentItem = __WEBPACK_IMPORTED_MODULE_0__js_store_js__["a" /* store */].currentItem;
    },
    loadItems: function loadItems() {
      var jsonUrl = "./src/js/ajax/bonsai.json";
      // check if empty
      var self = this;
      if (__WEBPACK_IMPORTED_MODULE_0__js_store_js__["a" /* store */].allItems === '') {
        __WEBPACK_IMPORTED_MODULE_3__js_jsonloader_js__["a" /* jsonLoader */].getJSON(jsonUrl).then(function (response) {

          // inject to all items  
          __WEBPACK_IMPORTED_MODULE_0__js_store_js__["a" /* store */].allItems = response.bonsai;
          self.refreshItems();
          console.log(__WEBPACK_IMPORTED_MODULE_0__js_store_js__["a" /* store */].allItems.length);
        }).then(function () {
    ...
    showSpecies: function showSpecies() {
      var self = this;
      var speciesToFilter = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__js_replace_js__["a" /* removeParamColons */])(self.$route.params.species);
      var filterSpecies = __WEBPACK_IMPORTED_MODULE_4__js_jsonFilter_js__["a" /* jsonFilter */].filter(speciesToFilter).then(function () {
    ...
    showId: function showId() {
      var self = this;
      var idToFilter = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__js_replace_js__["a" /* removeParamColons */])(self.$route.params.id);
      __WEBPACK_IMPORTED_MODULE_4__js_jsonFilter_js__["a" /* jsonFilter */].filterId(idToFilter).then(function () {
    ...
    customUrl: function customUrl() {
      __WEBPACK_IMPORTED_MODULE_1__index_js__["router"].push('/bonsai/:Goyomatsu/:goyomatsu3');
    }
  }
};
...
var jsonFilter = {
  filter: function filter(speciesToFilter) {
    return new Promise(function (resolve, reject) {
      ...
      resolve(__WEBPACK_IMPORTED_MODULE_0__store_js__["a" /* store */].state);
      // reject(Error("error"));
    }).then(function (resolved) {
      // success
      console.log("resolved");
      return __WEBPACK_IMPORTED_MODULE_0__store_js__["a" /* store */].state;
    }, function (err) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.id))])], 1), _vm._v(" "), _c('router-view', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('p', [_vm._v("vc-page-bonsai")]), _vm._v(" "), _c('div', {
    attrs: {
      "id": "galleryContainer"
    }
  }, _vm._l((_vm.currentItem), function(i) {
    return _c('div', [_c('div', {
      staticClass: "col-sm-12 col-sm-4"
    }, [_vm._v("\n        " + _vm._s(i.id) + " "), _c('br'), _vm._v("\n        " + _vm._s(i.thumb) + " "), _c('br'), _vm._v(" "), _c('img', {
      attrs: {
        "src": 'img/' + i.id + '.jpg',
        "id": i.id
      }
